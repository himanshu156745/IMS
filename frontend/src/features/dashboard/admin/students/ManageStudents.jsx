...
export default function ManageStudents() {
  ...
  const filtered = useMemo(() => {
    return students.filter((s) => {
      ...
      if (filters.hiringStatus && s.hiringStatus !== filters.hiringStatus) return false;
      if (filters.interviewStatus && s.interview.status !== filters.interviewStatus) return false;
      if (filters.applicationStatus && s.applicationStatus !== filters.applicationStatus) return false;
      return true;
    });
  }, [students, filters]);
    ...
    switch (key) {
      ...
      case "approve":
        setConfirmation({
          ...
          onConfirm: () => updateStudent({ ...student, applicationStatus: "Shortlisted" }),
        });
        break;
      case "reject":
        setConfirmation({
          ...
          confirmLabel: "Reject",
          danger: true,
          onConfirm: () => updateStudent({ ...student, applicationStatus: "Rejected" }),
        });
        break;
      case "changeHiring":
        setConfirmation({
          ...
          confirmLabel: "Update",
          onConfirm: () => updateStudent({ ...student, hiringStatus: "Interview Scheduled" }),
        });
        break;
      case "scheduleInterview":
        setConfirmation({
          ...
          onConfirm: () =>
            updateStudent({
              ...student,
              interview: { date: "Aug 01, 2026", time: "11:00 AM", mode: "Online", status: "Scheduled" },
            }),
        });
        break;
      case "sendEmail":
        ...
        break;
      case "viewResume":
        setDocumentPreview({ studentName: student.name, label: "Resume", fileName: student.documents.resume });
        break;
      case "viewDocuments":
        setDocumentPreview({
          studentName: student.name,
          label: "All Documents",
          fileName: [student.documents.resume, student.documents.collegeId, ...student.documents.certificates]
            .filter(Boolean)
            .join(", "),
        });
        break;
      case "delete":
        setConfirmation({
          ...
          confirmLabel: "Delete",
          danger: true,
          onConfirm: () => setStudents((prev) => prev.filter((s) => s.id !== student.id)),
        });
        break;
      default:
        break;
  ...
  return (
    <div className="bg-surface-alt/40 -m-6 md:-m-8 p-6 md:p-8 min-h-full">
      ...
      {profileStudent && <StudentProfileDrawer student={profileStudent} onClose={() => setProfileStudent(null)} />}
      ...
      {documentPreview && (
        <DocumentPreviewModal document={documentPreview} onClose={() => setDocumentPreview(null)} />
      )}
